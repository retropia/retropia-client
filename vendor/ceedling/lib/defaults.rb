...
DEFAULT_TEST_LINKER_TOOL = {
  ...
  :optional => false.freeze,
  :arguments => [
    ENV['LDFLAGS'].to_s.freeze,
    "\"${1}\"".freeze,
    "-o \"${2}\"".freeze,
    ENV['LIBS'].to_s.freeze
    ].freeze
  }
...
DEFAULT_CEEDLING_CONFIG = {
    ...
    :paths => {
      ...
      :support => [],
      :include => SystemWrapper.gcc_include_paths + FilePathUtils.extract_include_paths(ENV['CFLAGS']),
